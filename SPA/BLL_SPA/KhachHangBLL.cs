...
namespace BLL_SPA
{
    public class KhachHangBLL
    {
        ...
        //Thêm khách hàng mới vào file
        public void addKhachHangBLL(KhachHangDTO khthem)
        {

            KhachHangDAL.ListKhachHang.Add(khthem);


            KhachHangDAL.ghiFileDanhSachKH(@"../../../DAL_SPA/Data/DSKhachHang.xml");
